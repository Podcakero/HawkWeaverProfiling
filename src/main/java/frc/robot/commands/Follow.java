...
public class Follow extends Command {
  ...
  public Follow(String leftFile, String rightFile) 
  {
    ...
    leftCSV = new File("/home/lvuser/deploy/output" + leftFile + ".csv");
    rightCSV = new File("/home/lvuser/deploy/output" + rightFile + ".csv");
  ...
  protected void initialize() 
  {
    ...
    leftFollower.configureEncoder((int) RobotMap.driveTrainSubsystem.getLeftEncoderTicks(), RobotMap.DRIVETRAIN_ENCODER_TICKS_PER_REVOLUTION, RobotMap.DRIVETRAIN_WHEEL_DIAMETER / 12);
    rightFollower.configureEncoder((int) RobotMap.driveTrainSubsystem.getRightEncoderTicks(), RobotMap.DRIVETRAIN_ENCODER_TICKS_PER_REVOLUTION, RobotMap.DRIVETRAIN_WHEEL_DIAMETER / 12);
  ...
  protected void end() {
    ...
    RobotMap.driveTrainSubsystem.stopAll();
  }
  ...
  class RunProfile implements java.lang.Runnable {
    ...
    public void run() {
      ...
      RobotMap.driveTrainSubsystem.tankDrive(leftOutput + turn, rightOutput - turn, 0.0);
